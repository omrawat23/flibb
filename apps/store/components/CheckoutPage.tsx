...
const CheckoutPage: React.FC<Props> = ({
  ...
  const isConfigureOrderPage = typeof window !== 'undefined' && window.location.pathname === '/pages/order';
  ...
  return (
    <div className="checkout-container fixed bottom-9 right-4 md:right-auto md:top-12 md:mr-4 md:mt-2 z-20">
      ...
      {cartItems.length > 0 && (
        <div className="checkout-sidebar hidden md:flex fixed right-0 top-0 bottom-20 w-80 .grainy-dark  p-4 flex-col justify-between shadow-lg">
